...
\restrict cCbeW3i2jcn0Zxcd03aHXctu7PR2IFJi8mOXcyxHkR2XOi3d7WtMv3Ar3BcUGWk
...
CREATE TABLE public.transactions (
    ...
    service_code character varying(50) DEFAULT ''::character varying NOT NULL,
    transaction_type character varying(50) DEFAULT ''::character varying NOT NULL
);
...
CREATE TABLE public.users (
    id integer NOT NULL,
    email character varying(100) CONSTRAINT users_username_not_null NOT NULL,
    ...
    profile_image text DEFAULT 'https://yoururlapi.com/default-profile.jpg'::text
);
...
\unrestrict cCbeW3i2jcn0Zxcd03aHXctu7PR2IFJi8mOXcyxHkR2XOi3d7WtMv3Ar3BcUGWk
